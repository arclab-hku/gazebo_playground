...
export GAZEBO_RESOURCE_PATH=$GAZEBO_RESOURCE_PATH:~/yolo_dsst_tracker_ws/src/gazebo_sim/gazebo
export GAZEBO_MODEL_PATH=$GAZEBO_MODEL_PATH:~/yolo_dsst_tracker_ws/src/gazebo_sim/gazebo/models
